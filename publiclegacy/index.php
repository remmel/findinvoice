...
//bank
$bank = new App\Legacy\FakeBankin();
//is not logged
//if (!isset($_SESSION['email']) && !isset($_SESSION['password'])) {
//    header('Location: user.php');
//}
//$bank = new \Legacy\FakeBankConector();

//filesystem
$fileAdapter = new App\Legacy\FileAdapterGoogleDrive(DOCUMENTS_FOLDER_GDRIVE, $_SESSION['access_token']);
$fileAdapter->authenticateIfNeeded();

//$fileAdapter = new \Legacy\FileAdapterFilesystem(DOCUMENTS_FOLDER);
