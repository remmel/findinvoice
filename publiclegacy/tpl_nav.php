...
<!--            </li>-->
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item" href="/publiclegacy/user.phpser.php?action=logout">Bankin logout</a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="/publiclegacy/oauth2callback.php?action=logout">Google Drive logout</a>
                </div>
            </li>
        </ul>
